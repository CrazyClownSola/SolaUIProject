...
public abstract class CubicBezier {
    ...
    public PointF getPointF(float offset) {
        return new PointF(getBezierCoordinateX(offset), getBezierCoordinateY(offset));
    }
    ...
    private float getXDerivative(float t) {
